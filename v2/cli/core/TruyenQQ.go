...
func TruyenQQDownload(_url_web string) {
	...
	_img_urls_colly.OnHTML("img.lazy", func(e *colly.HTMLElement) {
		_img_links := e.Attr("src")
	...
	go func() {
		for _web_url := range _channels_link {
			...
			if err != nil {
				etc.Error("Please check your TruyenQQ URL!")
			}
	...
	_chapter_colly.OnHTML("h1[itemprop=name]", func(e *colly.HTMLElement) {
		_folder_name = e.Text
	...
	_chapter_colly.OnHTML("div.works-chapter-list a[href]", func(e *colly.HTMLElement) {
